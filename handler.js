...
text: '```🚩 Akses Bot Ke Private Chat Di Tolak, Silahkan Upgrade Premium Hanya 10.000 Idr Agar Bisa Bebas Akses Bot``',
contextInfo: {
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'mw ngapain kmu ( •̀ω•́ )',
        owner: 'mw ngapain kmu ( •̀ω•́ )',
        mods: 'mw ngapain kmu ( •̀ω•́ )',
        premium: '*ᴘʀᴇᴍɪᴜᴍ ᴏɴʟʏ •* ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ ᴍᴇᴍʙᴇʀ ᴘʀᴇᴍɪᴜᴍ !!',
        group: 'perintah ini khusus untuk di dalam group (¬_¬)',
         vip: 'mw ngapain kmu ( •̀ω•́ ).',
        private: 'cht lwat pribadi aja yaa (⁠•̀⁠ᴗ⁠-⁠)',
        admin: 'member gadiajak (`･ω･´)',
        ...
        nsfw: 'atmint menonaktifkan fitur *nsfw* di group ini, mungkin biar kmu ga sange :v',
        rpg: 'atmint menonaktifkan fitur *game rpg* di group ini😹',
        game: 'atmint menonaktifkan fitur *ɢᴀᴍᴇ* di group ini😹',
        limitExp: 'anjjr limitmu abiss, coba kembali besok (⁠｡⁠•̀⁠ᴗ⁠-⁠)',
        restrict: 'ꜰɪᴛᴜʀ ɪɴɪ ᴛɪᴅᴀᴋ ᴅᴀᴘᴀᴛ ᴅɪɢᴜɴᴀᴋᴀɴ !!',
        unreg: 'silahlan daftar ke database bot terlebih dahulu, jika ingin menggunakan perintah ini\n\n*MANUAL*: .daftar nama.umur\n*OTOMATIS*: @verify'
    }[type]

    if (msg) return conn.reply(m.chat, msg, m, {
        contextInfo: {
            externalAdReply: {
                title: 'Vanyla Ai', body: wm, sourceUrl: link.web, thumbnail: fs.readFileSync('./media/denied.jpg')
            }
        }
    })
}
